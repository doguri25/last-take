...
const version=JSON.parse(readFileSync(new URL('../package.json',import.meta.url),'utf8')).version;assert.equal(V.APP_VERSION,version);assert.equal(V.VERSION_HISTORY[0].version,version);assert.equal(V.VERSION_HISTORY.length,20);
