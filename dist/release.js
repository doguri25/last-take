...
export const VERSION_HISTORY=[
 {version:'1.6.0',date:'2026-09-12',title:'한국 시장형 정산과 다섯 단계의 경영',items:['시작 화면 난이도 5단계 · 기본 보통 · 저장별 난이도 유지','평균 결제액·부가세·극장·배급·원작료를 구분한 극장 정산','실제 투자금 비례 비용 회수 후 순이익 배분','영화 한 편 기준 인지도·직군·경력을 반영한 출연료','재무와 작품 상세에서 수익 정산 근거·손익분기 추정 확인','기존 영화 계약과 과거 거래·자금 보존','제작자: 도구리']},
 {version:'1.5.0',date:'2026-09-12',title:'제작사의 다음 장',items:['관심 인물과 최대 12개 제작팀 저장·불러오기','기획 보관함·3개 저장 슬롯·주간 자동 백업·JSON 파일 이전','관객층별 테스트 시사회와 재편집·보완 촬영·원안 유지','투자사 3곳의 공동제작 조건·기한·정산 배분','해외 5개 지역의 일시금·8주 수익 배분과 별도 성과','편집·사운드·촬영 시설의 임대·구입·유지비와 새 작품 효과','속편·프리퀄·스핀오프·리부트와 팬층·시리즈 피로·제작진 연속성','영화제 4곳의 출품·선공개 약정·선정·수상','기존 저장·과거 계약·모바일 뒤로가기 수정 보존','제작자: 도구리']} ,
 {version:'1.4.6',date:'2026-09-12',title:'영화 상세 뒤로가기 복사 오류 수정',items:['영화·인물·제작사 상세의 뒤로가기에서 발생하던 객체 복사 오류 수정','재무·흥행 그래프의 계산 함수를 화면 이동 기록과 분리','복귀할 때 그래프를 다시 구성하고 브라우저 뒤로가기·앞으로가기 유지','화면 기록에는 저장 가능한 데이터만 복사, 게임 진행·계약·현금 보존','제작자: 도구리']},
 {version:'1.4.5',date:'2026-09-12',title:'평가 이름·알림 읽음·대시보드 복귀 수정',items:['평론가·관객·OTT 시청자 상세평에서 평가자 이름의 세로 강제 줄바꿈 수정','알림 메시지 터치·키보드 선택 시 개별 읽음 처리와 배지 즉시 갱신·저장','관련 인물·작품 확인도 동일한 읽음 처리, 읽은 메시지는 알림함에 유지','이어서 플레이는 항상 제작 스튜디오 대시보드로 이동','미확정 기획은 자동 팝업 대신 대시보드에서 선택해 다시 편집','제작자: 도구리']},
 {version:'1.4.4',date:'2026-09-12',title:'주간 전환 게이지 제거',items:['주간 넘기기 팝업의 막대 게이지와 채움 애니메이션 제거','날짜·진행 안내·팝업 표시 시간·연속 진행 방지는 유지','제작자: 도구리']},
